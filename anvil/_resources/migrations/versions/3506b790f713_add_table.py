...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_backup_operations_backup_id'), 'backup_operations', ['backup_id'], unique=True)
    op.create_table('content_blobs',
    ...
    op.create_table('content_corpora',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['license_id'], ['license_catalog.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.ForeignKeyConstraint(['corpus_id'], ['content_corpora.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('corpus_id', 'manifest_digest', name='uq_content_versions_corpus_digest'),
    sa.UniqueConstraint('corpus_id', 'version_number', name='uq_content_versions_corpus_number')
    )
    ...
    op.create_table('instance_records',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_instance_records_name'), 'instance_records', ['name'], unique=True)
    op.create_table('license_catalog',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_runtime_config_key'), 'runtime_config', ['key'], unique=True)
    ...
    op.create_index('ix_content_entries_version_path', 'content_entries', ['version_id', 'path'], unique=False)
    op.create_table('content_ingest_sessions',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('corpus_id', sa.Integer(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.ForeignKeyConstraint(['accepted_version_id'], ['content_versions.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['corpus_id'], ['content_corpora.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['source_id'], ['content_sources.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('content_version_run_refs',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('version_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_content_version_run_refs_mlflow_run_id'), 'content_version_run_refs', ['mlflow_run_id'], unique=False)
    ...
    op.create_table('model_import_jobs',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('status', sa.String(length=20), nullable=False),
    sa.Column('source_type', sa.String(length=20), nullable=False),
    sa.Column('source_identifier', sa.String(length=255), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.ForeignKeyConstraint(['external_model_id'], ['external_models.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('content_import_jobs',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('corpus_id', sa.Integer(), nullable=False),
    sa.Column('source_id', sa.Integer(), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.ForeignKeyConstraint(['corpus_id'], ['content_corpora.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['session_id'], ['content_ingest_sessions.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['source_id'], ['content_sources.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('curation_operations',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_curation_operations_dataset_id'), 'curation_operations', ['dataset_id'], unique=False)
    ...
    op.create_index(op.f('ix_import_sources_dataset_id'), 'import_sources', ['dataset_id'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.ForeignKeyConstraint(['dataset_id'], ['datasets.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['import_source_id'], ['import_sources.id'], ),
    sa.ForeignKeyConstraint(['removed_by_op_id'], ['curation_operations.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('ix_samples_dataset_hash', 'samples', ['dataset_id', 'content_hash'], unique=False)
    op.create_index(op.f('ix_samples_dataset_id'), 'samples', ['dataset_id'], unique=False)
    op.create_index('ix_samples_dataset_index', 'samples', ['dataset_id', 'index'], unique=False)
    op.create_index('ix_samples_dataset_length', 'samples', ['dataset_id', 'length'], unique=False)
    op.create_index(op.f('ix_samples_is_removed'), 'samples', ['is_removed'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_curation_operations_dataset_id'), table_name='curation_operations')
    ...
    op.drop_index(op.f('ix_content_version_run_refs_mlflow_run_id'), table_name='content_version_run_refs')
    ...
    op.drop_index(op.f('ix_backup_operations_backup_id'), table_name='backup_operations')
