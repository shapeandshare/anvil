...
class TestLocalStdlibBackend:
    async def test_run_returns_correct_result(self, stdlib_backend, tiny_docs, tiny_config):
    ...
    async def test_progress_callback_called(self, stdlib_backend, tiny_docs, tiny_config):
    ...
    async def test_stop_check_before_start(self, stdlib_backend, tiny_docs, tiny_config):
...
class TestLocalTorchBackend:
    ...
    async def test_progress_callback_called_with_torch(self, torch_backend, tiny_docs, tiny_config):
