...
Covers: non-semantic click handlers, viewport zoom-disable, raw |safe /
...
CHECKS = [
    ...
    (
        "py-markup",
        "template",
        "Markup() — bypasses autoescape; audit input",
    ...
    (
        "py-autoescape",
        "template",
        "autoescape=False — escaping disabled at the environment",
