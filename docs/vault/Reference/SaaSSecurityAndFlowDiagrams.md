...
Security-, boundary-, and flow-focused diagrams complementing [[SaaSSystemDiagrams]]. Aligned with Architecture Decisions **AD-1..AD-16** in `docs/vault/Specs/016 SaaS Architecture/spec.md`.
...
- `docs/vault/Specs/016 SaaS Architecture/spec.md` — AD-1..AD-16, acceptance gates
- `docs/vault/Specs/016 SaaS Architecture/data-model.md` — schema source