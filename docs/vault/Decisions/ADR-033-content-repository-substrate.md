...
source: agent
code-refs:
  - docs/vault/Specs/019 LakeFS Content Repo/spec.md
  - docs/vault/Specs/019 LakeFS Content Repo/plan.md
  - docs/vault/Specs/019 LakeFS Content Repo/research.md
...
- `docs/vault/Specs/016 SaaS Architecture/spec.md`: `VersionedContentStore` added to the abstraction
