...
> **Cross-reference (added 2026-06-21): ADR-034 unifies this pattern across local and SaaS modes.**
...
> (single API key / session locally vs Cognito JWT in SaaS). See ADR-034 for the binding decision.
