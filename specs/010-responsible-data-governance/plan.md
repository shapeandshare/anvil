...
**Branch**: `010-responsible-data-governance` | **Date**: 2026-06-19 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/010-responsible-data-governance/spec.md`
...
```text
specs/010-responsible-data-governance/
