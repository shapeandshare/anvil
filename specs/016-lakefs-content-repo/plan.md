...
**Branch**: `016-lakefs-content-repo` | **Date**: 2026-06-20 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/016-lakefs-content-repo/spec.md`
...
`specs/014-saas-architecture/spec.md` (FR-062–FR-067, SC-021).
...
- **SaaS spec enhanced (cross-feature)**: the SaaS-mode consequences of this feature were
  propagated into `specs/014-saas-architecture/spec.md` — `VersionedContentStore` added to
