...
**Branch**: `007-automated-semver-release` | **Date**: 2026-06-14 | **Spec**: [spec.md](spec.md)
**Input**: Feature specification from `/specs/007-automated-semver-release/spec.md`
...
```text
specs/007-automated-semver-release/
├── plan.md              # This file
