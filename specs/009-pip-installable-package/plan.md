...
**Branch**: `009-pip-installable-package` | **Date**: 2026-06-18 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/009-pip-installable-package/spec.md`
...
```text
specs/009-pip-installable-package/
├── plan.md              # This file
